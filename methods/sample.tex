...
\label{section:sample-preparation}
    ...
    \begin{wrapfigure}[18]{r}{40mm}
        ...
        \begingroup
        \ooalign{%
            {\fontsize{7pt}{9pt}\selectfont\import{methods/sample/probe}{probe.pdf_tex}}\cr
    ...
    \label{subsection:design}
        ...
        \begin{figure}[t]
            ...
            \import{methods/sample/ebeamdesign}{ebeam.pdf_tex}
            }
            \caption{Electron-beam lithography design of the sample at different length scales. The overview at the bottom shows the full pattern including leads and contact pads, while the upper panels successively magnify the central device region down to 100\,\textmu m, 10\,\textmu m, and 1\,\textmu m scales. Blue structures (\legend{seeblau100}) are written in a 100\,\textmu m writing field, whereas gray structures (\legend{seegrau100}) are written in 1000\,\textmu m writing fields. In the overview, the individual writing fields are indicated by dashed squares. The detailed views show the break junction, the island, the oxide-barrier finger, the nearby DC gate, and the adjacent AC gate. The outer leads are arranged to simplify electrical contacting, and a shorting structure is included to protect the sample against electrostatic discharge.}
            % label subfigures?
