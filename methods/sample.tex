...
%=========================================================
    ...
    \label{subsection:concept}
        ...
        In the final fabrication step, approximately \qty{500}{\nano\meter} of the PI layer is removed by oxygen plasma etching. Because the etch proceeds essentially homogeneously, a pronounced undercut is created, as illustrated in Fig.~\ref{fig:methods:sem}. This step releases the bridge and renders the break junction freestanding.
