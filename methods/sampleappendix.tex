...
\label{subsection:realization}
    ...
    \subsubsection*{Plasma Etching}
        ...
        \begin{figure}
            ...
            \caption{Recorded laser intensity during the plasma-etch process.}
