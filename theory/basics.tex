...
%=========================================================
    ...
    %=========================================================
        ...
        %=========================================================
            ...
            In the ballistic, phase-coherent limit the normal-state conductance $G_\mathrm{N}$ is most naturally obtained from the scattering approach discussed in the mesoscopic chapter (see Sec.~\ref{subsec:meso:scattering}). In linear response at low temperature it is given by the Landauer formula
            \begin{equation}
