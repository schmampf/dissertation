...
%=========================================================
    ...
    %=========================================================
        ...
        \begin{equation}
            ...
            = V_\text{ion}(\vec{r})
            \label{eq:basics:ionic-periodicity}
        \end{equation}
        ...
        %=========================================================
            ...
            \begin{equation}
                ...
                \label{eq:basics:quasiparticle-velocity}
            \end{equation}
        ...
        %=========================================================
            ...
            \begin{equation}
                ...
                \label{eq:basics:drift-velocity}
            \end{equation}
            ...
            \begin{equation}
                ...
                \label{eq:basics:mean-free-path}
            \end{equation}
            ...
            \begin{equation}
                ...
                \label{eq:basics:diffusion-constant}
            \end{equation}
    ...
    %=========================================================
        ...
        %=========================================================
            ...
            \begin{equation}
                ...
                \label{eq:basics:diffusive-coherence-length}
            \end{equation}
            ...
            \begin{equation}
                ...
                \label{eq:basics:thermal-length}
            \end{equation}
        ...
        %=========================================================
            ...
            \begin{equation}
                ...
                \label{eq:basics:ballistic-coherence-length}
            \end{equation}
    ...
    %=========================================================
        ...
        For mesoscopic aluminum structures the phase-coherence length $\ell_\phi$ is not a fixed material constant but depends on temperature, disorder, geometry, and the electromagnetic environment. An atomic contact is nevertheless much shorter than the elastic and dephasing lengths reached at low temperature. Aluminum contacts can therefore be treated as ballistic and phase coherent on the scale of the constriction, which justifies applying the transmission-channel model to the measured contacts \cite{scheer_conduction_1997, agrait_quantum_2003}.
        ...
        %=========================================================
            ...
            \begin{equation}
                ...
                \label{eq:basics:aluminum-clean-coherence-length}
            \end{equation}
            yielding a value of order $1$--$2\,\text{\textmu m}$ for aluminum. At zero temperature, a useful diffusive superconducting scale is
            \begin{equation}
                \xi_{\mathrm{dirty},0}
                = \sqrt{\frac{\hbar D}{\Delta_0}}\,.
                \label{eq:basics:aluminum-dirty-coherence-length}
            \end{equation}
            ...
            \begin{equation}
                ...
                \label{eq:basics:aluminum-gl-coherence-length}
            \end{equation}
        ...
        %=========================================================
            ...
            In the context of this thesis, artificially grown aluminum oxide defines the tunnel barriers in our SIS junctions, while the native surface oxide influences the mechanical response of thin aluminum electrodes \cite{murray_material_2021,saif_effect_2002}. Aluminum therefore supplies both limiting structures considered later: low-transparency oxide barriers and highly transmitting atomic contacts. The next subsection adds the time-dependent drive used to probe both limits.
    ...
    %=========================================================
        ...
        %=========================================================
            ...
            \begin{align}
                ...
                \label{eq:basics:mw-phase-decomposition}
            \end{align}
            where
            \begin{equation}
                ...
                \qquad\text{and}\qquad
                \alpha = \frac{q A}{h\nu}\,,
                \label{eq:basics:mw-drive-parameters}
            \end{equation}
