...
%=========================================================
    ...
    %=========================================================
        ...
        \begin{wrapfigure}{R}{0.4\textwidth}
            ...
            \captionof{figure}{CPR of a weakly coupled Josephson junction (Eq.~\ref{eq:macro:dc}).}
        ...
        \begin{wrapfigure}{R}{0.4\textwidth}
            ...
            \caption{Combined supercurrent and quasiparticle contribution to the \textit{I--V} characteristic.}
    ...
    %=========================================================    
        ...
        \end{wrapfigure}
        The potential is obtained by identifying the restoring force with $-\partial U/\partial\phi = I_\mathrm{C}\sin\phi$, which yields
        \begin{equation}
            U(\phi)
            = -\,\cos\phi \;-\; i\,\phi\,.
        ...
        In the full RCSJ model, Shapiro steps arise through frequency locking between the intrinsic Josephson oscillation and an external microwave drive. Adding a drive of amplitude $a$ and angular frequency $\omega$ modifies the normalized RCSJ equation to
            \begin{equation}
                \ddot{\phi} + \frac{1}{Q}\dot{\phi} + \sin\phi
                = i + a\sin(\omega t).
                \label{eq:macro:rcsj-driven}
            \end{equation}
        where $i$ is the normalized bias current. When the average phase velocity locks to an integer multiple of the drive frequency, the junction develops a dc voltage producing the characteristic Shapiro plateaus.
        ...
        Figure~\ref{fig:macro:rcsj-shapiro-iv} shows the resulting \textit{I--V} characteristics in the overdamped limit. The phase locks robustly to the external drive, producing a sequence of Shapiro plateaus.
        \begin{figure}[h]
            \centering
            \includegraphics[width=.45\textwidth]{theory/macro/rcsj-shapiro-iv.png}
            \caption{
                \textbf{in progress.. über dies caption muss auch nochmal der refiner drüber}\\
                Shapiro steps in the overdamped regime ($Q\ll 1$). Strong damping suppresses residual oscillations of the phase, stabilizing clean voltage plateaus at $V_n = nh\nu/2e$. Only the overdamped case is shown, reflecting the parameter regime relevant for the aluminum tunnel junctions investigated in this work.
            }
