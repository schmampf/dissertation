...
%=========================================================
    ...
    %=========================================================
        \begin{figure}[t]
            ...
            \caption{
                Microwave-driven transport in a weakly coupled Josephson junction with $T=0$, $\gamma=0$, and $\nu=10.0\,\mathrm{GHz}$.
                }
    ...
    %=========================================================    
        ...
        %=========================================================
            ...
            In the full RCSJ model, Shapiro steps arise through frequency locking between the intrinsic Josephson oscillation and the external microwave drive defined in Sec.~\ref{subsec:micro:pat}. The normalized RCSJ equation becomes
            \begin{equation}
                i + a\sin(2\pi\nu' t')
                = \sin\phi
                + \frac{1}{Q}\,\frac{\mathrm{d}\phi}{\mathrm{d}t'}
            ...
            \begin{figure}
                ...
                \caption{
                    Microwave-driven dc transport of a Josephson junction within the RCSJ model for (a) underdamped and (b) overdamped phase dynamics. Parameters are $\nu=10\,\mathrm{GHz}$ and $T=\gamma=0$.
                    }
