...
%=========================================================
    ...
    %=========================================================
        ...
        When a Josephson junction is exposed to an external microwave field, the phase dynamics become modulated by the drive introduced in Section~\ref{subsec:platform:microwave}. The Josephson frequency $\nu_0$ mixes with the external frequency $\nu$, and the phase takes the form
        \begin{equation}
