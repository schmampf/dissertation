...
%=========================================================
    ...
    The following subsections introduce the two Josephson relations, apply the electromagnetic-drive convention of Sec.~\ref{subsec:micro:pat} to microwave-driven junctions, and develop the RCSJ model for dissipative phase dynamics.
    ...
    %=========================================================
        \begin{figure}[t]
            ...
            \caption{
                Microwave-driven transport in a weakly coupled Josephson junction. Aluminum parameters from Eq.~\eqref{eq:micro:aluminum-scales} are used, with $T=0$, $\gamma=0$, and $\nu=10.0\,\mathrm{GHz}$.
                }
    ...
    %=========================================================    
        ...
        %=========================================================
            ...
            \begin{figure}
                ...
                \caption{
                    Microwave-driven dc transport of a Josephson junction within the RCSJ model for (a) underdamped and (b) overdamped phase dynamics. Shown is the normalized bias current $I_\mathrm{bias}/(G_\mathrm{N}\Delta_0/e)$ versus the normalized voltage $eV/\Delta_0$ for drive amplitudes $eA/\Delta_0\in\{0,0.3,0.6\}$ at $\nu=10\,\mathrm{GHz}$. Aluminum parameters from Eq.~\eqref{eq:micro:aluminum-scales} are used, with $T=0$ and $\gamma=0$.
                    }
