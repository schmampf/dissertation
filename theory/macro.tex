...
%=========================================================
    ...
    The following subsections introduce the two Josephson relations, apply the voltage and phase conventions of Sec.~\ref{subsec:platform:microwave} to microwave-driven junctions, and develop the RCSJ model for dissipative phase dynamics.
    ...
    %=========================================================
        \begin{figure}[t]
            ...
            \caption{
                Microwave-driven transport in a weakly coupled Josephson junction. Parameters correspond to aluminum (Sec.~\ref{subsec:platform:aluminum}), with $T=0$, $\gamma=0$, and $\nu=10.0\,\mathrm{GHz}$.
                }
        ...
        When a Josephson junction is exposed to an external microwave field, the phase dynamics become modulated by the drive introduced in Sec.~\ref{subsec:platform:microwave}. For Cooper-pair transfer, the charge-dependent drive phase is evaluated at $q=2e$ and contributes directly to the superconducting phase difference. The Josephson frequency $\nu_0$ then mixes with the external frequency $\nu$, and the phase takes the form
        \begin{equation}
        ...
        Inserting this expression into the Josephson current-phase relation (Eq.~\ref{eq:macro:dc}) and expanding the phase modulation using the Jacobi-Anger identity (Eq.~\ref{eq:platform:jacobi-anger}) yields harmonics at frequencies $\nu_0 - n\nu$. Whenever the resonance condition $\nu_0 = n\nu$ is satisfied, the $n$-th harmonic becomes stationary and contributes a finite dc component to the current. This produces quantized voltage plateaus at
        \begin{equation}
            V_n = \frac{nh\nu}{2e}\,,
    ...
    %=========================================================    
        ...
        %=========================================================
            ...
            In the full RCSJ model, Shapiro steps arise through frequency locking between the intrinsic Josephson oscillation and an external microwave drive, as described in Section~\ref{subsec:platform:microwave}. The normalized RCSJ equation becomes
            \begin{equation}
                i + a\sin(2\pi\nu' t')
                = \sin\phi
                + \frac{1}{Q}\,\frac{\mathrm{d}\phi}{\mathrm{d}t'}
