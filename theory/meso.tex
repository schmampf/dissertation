...
%=========================================================
    ...
    The clean-limit BCS coherence length connects the aluminum Fermi velocity to the superconducting gap,
    \begin{equation}
        \xi_0 = \frac{\hbar v_\mathrm{F}}{\pi\Delta_0}\,.
        \label{eq:meso:aluminum-clean-coherence-length}
    \end{equation}
    For aluminum, this gives a value of order $1$--$2\,\text{\textmu m}$. In a diffusive film, the corresponding zero-temperature decay length is
    \begin{equation}
        \xi_{\mathrm{dirty},0}
        = \sqrt{\frac{\hbar D}{\Delta_0}}\,,
        \label{eq:meso:aluminum-dirty-coherence-length}
    \end{equation}
    which is typically of order $100$--$300\,\mathrm{nm}$ for evaporated aluminum films. Both lengths are much larger than an atomic constriction and support the short-junction description used below. \cite{tinkham_introduction_2004,steinberg_quasi-particle_2008}
    
        %=========================================================
        \subsubsection*{Single Particle Hamiltonian}
        %=========================================================

            We use the effective normal-state Hamiltonian introduced in Eq.~\eqref{eq:quasi:normal-hamiltonian}. In the grand-canonical ensemble, where energies are measured relative to the chemical potential, it reads
            \begin{equation}
                \hat{H}_\mathrm{N}(\vec{r}) = -\frac{\hbar^2}{2m^\ast}\nabla^2 + U(\vec{r}) - \mu\,,
                \label{eq:meso:h-n}
            \end{equation}
            where the effective mass $m^\ast$ and the possibly spatially varying potential $U(\vec r)$ retain the same meaning as in the normal-state description. In a device model, $U(\vec r)$ accounts for confinement, tunnel barriers, and disorder.
            ...
            \begin{equation}
                ...
                \varepsilon_{\vec q}=\tfrac{\hbar^2 q^2}{2m^\ast}\,.
            \end{equation}
        ...
        %=========================================================
            ...
            \begin{equation}
                ...
                \xi_{\vec q}=\frac{\hbar^2 q^2}{2m^\ast}-\mu\,,\qquad
        ...
        The absence of propagating subgap quasiparticles in a homogeneous superconductor is the microscopic origin of Andreev conversion at an NS interface. In particular, the spectrum $E^2=\xi^2+|\Delta|^2$ implies the familiar BCS density of states, Equation~\eqref{eq:micro:dos-bcs}, while for $|E|<|\Delta|$ one must describe transport in terms of coherent electron--hole conversion processes.
    ...
    %=========================================================
        ...
        %=========================================================
            ...
            \begin{figure}[t]
                ...
                \caption{
                    BTK spectral weights of the single-particle (1e) and two-particle (2e) channels and the corresponding \textit{I--V} and \textit{dI--dV} characteristics for various channel transparencies $\tau$ at $T=0$ and $\gamma=0$. Increasing $\tau$ shifts spectral weight from normal to Andreev processes, leading to enhanced subgap conductance and reduced coherence-peak height.
                    }
                \label{fig:meso:btk}
            \end{figure}
