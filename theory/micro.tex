...
%=========================================================
    ...
    The following subsections introduce the temperature dependence of the superconducting gap, the superconducting DOS and its phenomenological broadening, and the tunnel-current expressions that connect these quantities to spectroscopy. The final subsection extends the static tunnel model to photon-assisted transport using the electromagnetic phase defined in Sec.~\ref{subsec:basics:micro-wave}.
    ...
    %=========================================================
        ...
        \begin{figure}
            ...
            \caption{
                Dynes broadening and thermal occupation set the spectral resolution of microscopic tunnel spectroscopy. Together they determine the line shape of the corresponding \textit{I--V} and \textit{dI--dV} characteristics. Parameters correspond to aluminum in Sec.~\ref{subsec:basics:aluminum}.
                }
    ...
    %=========================================================
        \begin{figure}[ht]
            ...
            \caption{
                Photon-assisted tunneling in NS (grey) and SS (blue) junctions. The microwave drive couples electronic states differing in energy by $h\nu$, producing sideband replicas of the static \textit{I--V} and \textit{dI--dV} characteristics. Parameters correspond to aluminum (Sec.~\ref{subsec:basics:aluminum}), with $T = 0$, $\gamma = 0$, and $\nu = 10.0\,\mathrm{GHz}$.
                }
            \label{fig:micro:pat}
        \end{figure}

        In the static tunneling expressions above, the Hamiltonian is time-independent and the Bardeen tunneling matrix element carries only its intrinsic phase. Once a microwave drive is applied, as introduced in Section~\ref{subsec:basics:micro-wave}, this matrix element acquires the time-dependent phase factor of Eq.~\ref{eq:microwave:phase-factor}. Here the relevant charge for quasi-particle tunneling is $q=e$. The drive thus modulates the single-electron tunneling phase, not the macroscopic superconducting phase, and this modulation is the microscopic origin of photon-assisted tunneling (PAT).
