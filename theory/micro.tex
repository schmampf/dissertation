...
%=========================================================
    ...
    \end{equation}
    Its magnitude represents the pairing strength, while its phase encodes macroscopic phase coherence. In the Bogoliubov--de~Gennes formalism, $\Delta(\vec{r})$ appears as the pairing potential that couples electron and hole amplitudes. Although this connection is fundamental and belongs to the microscopic mean-field description, we postpone its discussion to the mesoscopic treatment in Section~\ref{subsec:meso:bdg}. \cite{bogoljubov_new_1958,de_gennes_boundary_1964,de_gennes_superconductivity_1966}
