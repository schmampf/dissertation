...
\label{sec:micro}
    ...
    \label{subsec:micro:sc-gap}
        ...
        Solving the underlying integrals over the Fermi distribution in the microscopic theory numerically, results in the following Equation \ref{eq:micro:DeltaT} or shown in Figure \ref{fig:micro:gap_suppression}.
        \begin{equation}
    ...
    \label{subsec:micro:tunnel-current}
        ...
        \begin{figure}
            ...
            \caption{
                ...
                % Increasing temperature smooths the current onset at $eV = \Delta_0$ in NS junctions, while in SS junctions coherence peaks decreases as the gap closes and at zero voltage a finite differential conductance appears.
                % A finite $\Gamma$ introduces lifetime broadening into the superconducting density of states, rounding off the coherence peaks and generating subgap conductance. In contrast to thermal effects, Dynes broadening modifies the DOS directly and therefore affects NS and SS spectra in a quantitatively different manner.
                }
    ...
    \label{subsec:micro:pat}
        ...
        In contrast to the macroscopic description of phase-coherent Cooper-pair dynamics discussed later in Section~\ref{subsec:macro:shapiro}, the microscopic PAT picture describes incoherent quasi-particle tunneling modified by an external time-dependent voltage.
        ...
        \end{equation}
        which replaces $N_2(E)$ in the tunneling expression. The PAT-modified current therefore becomes a weighted sum of shifted copies of the static \textit{I-V} curve.
