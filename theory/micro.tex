...
%=========================================================
    ...
    %=========================================================
        ...
        Figure~\ref{fig:micro:dos-fermi}(a) visualizes how Dynes broadening smooths the coherence peaks of $N_\mathrm{S}(E)$, while Fig.~\ref{fig:micro:dos-fermi}(b) shows how finite temperature smears the Fermi edge. The resulting thermal broadening kernel in Fig.~\ref{fig:micro:dos-fermi}(c) sets the intrinsic energy resolution of tunneling spectroscopy.
        \begin{figure}
            \centering
            \subfigure[
