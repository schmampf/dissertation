...
%=========================================================
    ...
    %=========================================================
        ...
        \begin{figure}
            ...
            \caption{
                Dynes broadening and thermal occupation set the spectral resolution of microscopic tunnel spectroscopy. Together they determine the line shape of the corresponding \textit{I--V} and \textit{dI--dV} characteristics. Aluminum parameters from Eq.~\eqref{eq:micro:aluminum-scales} are used.
                }
    ...
    %=========================================================
        ...
        \begin{figure}[ht]
            ...
            \caption{
                Temperature and Dynes broadening modify NS and SS tunnel spectra in distinct ways. Temperature mainly broadens occupation and fills the subgap region, while Dynes broadening smooths DOS singularities and suppresses coherence peaks. The NN curve is shown in grey as reference. Aluminum parameters from Eq.~\eqref{eq:micro:aluminum-scales} are used.
                }
    ...
    %=========================================================
        ...
        \begin{figure}[t]
            ...
            \caption{
                A harmonic junction voltage generates a charge-dependent phase modulation and a discrete sideband spectrum. Parameters use aluminum scales from Eq.~\eqref{eq:micro:aluminum-scales}, with $q=e$, $eV_0=0.5\,\Delta_0$, $eA=0.5\,\Delta_0$, and $\nu=10\,\mathrm{GHz}$.
            }
        ...
        \begin{figure}[ht]
            ...
            \caption{
                Photon-assisted tunneling in NS (grey) and SS (blue) junctions. The microwave drive couples electronic states differing in energy by $h\nu$, producing sideband replicas of the static \textit{I--V} and \textit{dI--dV} characteristics. Aluminum parameters from Eq.~\eqref{eq:micro:aluminum-scales} are used, with $T=0$, $\gamma=0$, and $\nu=10.0\,\mathrm{GHz}$.
                }
            \label{fig:micro:pat}
        \end{figure}
