...
\label{sec:micro}
    ...
    \label{subsec:micro:sc-gap}
        ...
        Solving the underlying integrals over the Fermi distribution in the microscopic theory numerically, results in the following equation or shown in Figure \ref{fig:micro:gap_suppression}.
        \begin{equation}
    ...
    \label{subsec:micro:dos}
        ...
        However, real spectra are never perfectly sharp. A simple and very effective phenomenology is the Dynes broadening, implemented by the substitution $E\to E+\ima\Gamma$, while just considering the real part of the whole expression
        \begin{equation}
        ...
        \begin{figure}
            ...
            \caption{smearing of $N_\mathrm{S}$ due to increasing $\Gamma$, smearing of $f$ due to increasing $T$}
