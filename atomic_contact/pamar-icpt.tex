...
%=========================================================
    ...
    \subsubsection*{Photon Assisted Incoherent Cooper Pair Tunneling}
        ...
        \begin{figure}[t]
            ...
            \subfigure[
                exp
                ]{\import{atomic_contact/2.4G0/15.0GHz_stripline/didv-img}{dGexp.pgf}}
            \subfigure[
                sim
                ]{\import{atomic_contact/2.4G0/15.0GHz_stripline/didv-img}{dGpamar.pgf}}
            \caption{
                bla
            }
    ...
    %     \subfigure[
    %         test
    %     ]{\import{atomic_contact/1.8G0/15.0GHz_stripline/didv-img}{exp.pgf}}
    %     \hfill
    %     \subfigure[
    %         test
    %     ]{\import{atomic_contact/1.8G0/15.0GHz_stripline/didv-img}{sim.pgf}}
    %     \\
    %     \subfigure[
    %         test
    %     ]{\import{atomic_contact/1.8G0/15.0GHz_stripline/didv-img}{fcspamar.pgf}}
    %     \hfill
    %     \subfigure[
    %         test
    %     ]{\import{atomic_contact/1.8G0/15.0GHz_stripline/didv-img}{pamar.pgf}}
    %     \\
    %     \subfigure[
    %         test
    %     ]{\import{atomic_contact/1.8G0/15.0GHz_stripline/didv-img}{sp.pgf}}
    %     \hfill
    %     \subfigure[
    %         test
    %     ]{\import{atomic_contact/1.8G0/15.0GHz_stripline/didv-img}{icpt.pgf}}
    ...
    % \end{figure}
        ...
        %     \subfigure[
        %         test
        %     ]{\import{atomic_contact/1.8G0/15.0GHz_stripline/dvdi-img}{exp.pgf}}
        %     \caption{
        %         bla
        %     }
        %     \label{fig:ac:contact1:exp-img}
        % \end{figure}
