...
%=========================================================
    ...
    I performed these measurements on sample AC\footnote{In the lab book AC is called `PR-22e-09'.}, shown in Fig.~\ref{fig:ac:image-AC}. The device was fabricated as an aluminum mechanically controllable break junction. The principle of the cryogenic and electrical setup is described in Sec.~\ref{sec:methods:setup}. The actual state of the setup is described in Ref.~\cite{raif_electronic_2024}. The synchronized acquisition and evaluation procedure is described in Sec.~\ref{sec:methods:digital}.

    All measuremnts outside of Sec.~\ref{subsec:ac:pincode} are done together with Patrick Raif during his Master thesis \cite{raif_electronic_2024}.
