...
%=========================================================
    ...
    %=========================================================
        ...
        \begin{figure}[p]
            ...
            \caption{
                Temperature-dependent transport-landscape figure of TB1 on the remapped $T_\mathrm{fit}$ axis. The three columns show the measured \textit{I--V}, \textit{dI--dV}, and \textit{dV--dI} response, while the rows show representative traces, a surface view, and a false-color map of the same data.
            }
