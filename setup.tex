    ...
    \section{Data Acquisition}
        ...
        \subsection{DC Measurement Concept}
            ...
            Previosly for SSET experiments at the Scheer2 cryostat a combintation of NF, SRT and a similar ADC (by NI) was used by References \cite{Lorenz2018,Sprenger2019,SobralRey2022}. On the Bluefors a combination of Femto amplifier and keysight multimeter was used by Reference \cite{Prestel2020}.
            ...
            As a source, the function generator, used by References \cite{Lorenz2018,Sprenger2019,SobralRey2022}, KeysightB, used by \cite{Prestel2020} and the DAC of the already used ADwin. Again, the usage of ADwin was best for the lowest noise floor. However, to enhance the resolution, part of the 
            - {layout}
            - {AD converter}
            - {Pre Amplifier}
