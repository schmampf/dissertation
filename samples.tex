...
\label{chapter:methods}
    ...
    \section{Sample Preparation} \label{sec:sample preparation}
        ...
        Single-electron transistors (SETs) consist of two junctions forming a small island, which is capacitively coupled to a DC gate electrode. Typically, this configuration is achieved using two oxide barriers in a lead, fabricated through shadow evaporation \cite{fulton_observation_1987,henning_charging_1999,krupenin_metallic_2001}.
