...
%=========================================================
    ...
    \vspace*{-.3in}
        \begin{center}
            ...
            \hfill%
            \subfigure[$\mathrm{d}I/\mathrm{d}V$]{%
                \parbox[t]{2.1in}{%
                    \centering
            ...
            \hfill%
            \subfigure[$\mathrm{d}V/\mathrm{d}I$]{%
                \parbox[t]{2.1in}{%
                    \centering
    ...
    %=========================================================
        ...
        After offset correction I rebinned to fixed axes and computed experimental maps for $I(V)$, $\mathrm{d}I/\mathrm{d}V(V)$, $V(I)$, and $\mathrm{d}V/\mathrm{d}I(I)$. I normalized conductance with the fitted normal conductance scale $G_\mathrm{N}=\tau_0 G_0$.
