...
%=========================================================
    ...
    The tunnel barrier serves as a controlled reference system for the analysis of microwave-driven superconducting transport. Compared with atomic contacts, it has a simpler and well-established transport theory, while still producing data with the same practical complications: finite temperature, broadening, microwave-induced replicas, voltage offsets, amplitude calibration, and multidimensional parameter dependence. It therefore provides a useful intermediate step between the theoretical description of photon-assisted tunneling and the more complex behavior of superconducting atomic contacts.

    This chapter has several purposes. First, it introduces how the measured data are read and interpreted. Even for a tunnel barrier, the relevant data sets are multidimensional: current and differential conductance depend on bias voltage, microwave frequency, microwave power, temperature, and magnetic field. The tunnel barrier provides a comparatively transparent system in which these dependences can be separated and connected to specific physical mechanisms.

    Second, the tunnel barrier allows a direct comparison with established theory. In the absence of microwave irradiation, the quasiparticle current is described by the convolution of superconducting densities of states with thermally broadened Fermi functions. Under microwave irradiation, photon-assisted tunneling can be modeled using the Tien--Gordon approach. The agreement and deviations between measurement and model provide a quantitative test of the experimental setup and the analysis procedure.

    Third, the tunnel barrier is used as a calibration tool. The thermal broadening of the quasiparticle onset gives access to the effective electronic temperature, while the microwave-induced sidebands provide a calibration of the local ac voltage amplitude at the junction. At the same time, systematic uncertainties such as voltage offsets, voltage scaling errors, and residual broadening can be identified more reliably than in atomic contacts, where several transport processes overlap.

    Finally, the tunnel barrier reveals that even a nominally simple system, whose basic transport theory has been established for decades, can still exhibit previously unresolved effects when investigated with sufficient precision. In particular, we observe a frequency-dependent rectification signal that cannot be understood from the elementary quasiparticle tunneling picture alone. We attribute this behavior to the influence of a physically coupled electromagnetic resonator, which modifies the local microwave environment of the junction. The observation of this effect required high-precision measurements, long and systematic parameter sweeps, and a detailed multidimensional data analysis. In this sense, the tunnel barrier is not only a calibration sample, but also demonstrates that even the simplest superconducting junctions can reveal additional physics beyond the standard description when studied in sufficient detail.
