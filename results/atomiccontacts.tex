% !TEX root = ../thesis.tex
\section{Few-channel atomic contacts}

Chapter 4 -- Few-Channel Atomic Contacts

4.1 \subsection{Concept of Quantum Channels in Superconducting Atomic Contacts}
...
4.2 \subsection{Reproduction of Scheer et al. Measurement (your highlight)}
...
4.3 \subsection{Photon-Assisted Multiple Andreev Reflection (PAMAR)}
