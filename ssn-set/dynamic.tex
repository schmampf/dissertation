...
%=========================================================
    ...
    \end{align}
    After I suppressed superconductivity, the intact device showed no resolvable deviation from a linear normal-state response and no zero bias anomaly within the measurement noise. This measurement established the fixed tunnel barrier as a reference before I changed the mechanical configuration.
