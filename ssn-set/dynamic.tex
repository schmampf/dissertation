...
%=========================================================
    ...
    I then partially opened the MCBJ. Unlike SET1, the resulting configuration did not show periodic gate modulation. Its normal-state conductance measured at $T_\mathrm{bath}=\qty{70(1)}{\milli\kelvin}$ was nevertheless suppressed around zero bias, as shown in Fig.~\ref{fig:ssn2-set:dcb}. I fitted this anomaly with the effective RC environment introduced in Sec.~\ref{subsec:stochastic:dcb}. The fit reproduced the voltage dependent conductance with
    \begin{align}
