...
%=========================================================
    ...
    \end{align}
    I approximated the uncertainties by the half-widths of the visible crossover intervals in \textit{dI--dV} and \textit{dV--dI}. They therefore quantify the crossover width rather than statistical fit uncertainty.
